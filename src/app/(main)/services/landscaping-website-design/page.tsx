...
export const metadata: Metadata = {
  title:
    "Website Design for Landscaping Companies in Indianapolis | JadorWorks Web Studio",
  description:
    "Professional website design for landscaping companies in Indianapolis. Showcase your projects, attract homeowners, and rank in local search. Launch in 1-2 weeks.",
  openGraph: {
    title:
      "Website Design for Landscaping Companies in Indianapolis | JadorWorks Web Studio",
    description:
      "Professional website design for landscaping companies in Indianapolis. Showcase your projects, attract homeowners, and rank in local search.",
    url: "https://jadorworks.com/services/landscaping-website-design",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Landscaping Website Design for Indianapolis Companies — JadorWorks Web Studio",
      },
    ],
    locale: "en_US",
    type: "website",
...
const jsonLd = {
  ...
  description:
    "Professional website design for landscaping companies in Indianapolis and across Indiana. Showcase projects, attract homeowners, and rank in local search.",
  areaServed: {
    "@type": "City",
    name: "Indianapolis",
    containedInPlace: {
...
const included = [
  {
    ...
    description:
      "A clean, mobile-friendly site built around your services and project photos — designed to attract homeowners in your service area who are ready to book.",
    icon: (
...
const whyReasons = [
  {
    num: "01",
    title: "Built around how homeowners hire landscapers",
    description:
      "Most landscaping customers search by service and location — \"lawn care Carmel IN\" or \"landscaping company Fishers.\" We structure every page around the specific services and cities you serve, so your site shows up when the right customer is looking.",
  },
  {
    num: "02",
...
const faqs = [
  {
    question: "What pages should a landscaping website have?",
    answer:
      "Every landscaping site needs a clear services list, a project gallery, a service area section, and a contact or quote request form. We build all of this into a structured, search-optimised site from day one.",
  },
  {
    question: "Do I need to provide photos of my work?",
    answer:
      "Yes — and it is worth it. Before-and-after photos of real projects are the strongest trust signal a landscaping business can have. We will guide you on what to submit and how to present them effectively.",
  },
  {
    question: "How will my website help me get more clients?",
    answer:
      "Your site will be structured to rank for local searches, showcase your work, and make it easy for homeowners to request a quote. Every section is built around moving a visitor toward contacting you.",
  },
  {
    question:
      "Can you target specific cities and services in Indiana?",
    answer:
      "Yes — this is one of the most important things we do. Each service and service area gets the right page structure and schema markup so your business shows up when someone in Carmel, Fishers, or Avon is searching for exactly what you offer.",
  },
  {
    question: "Will my site work on mobile?",
    answer:
      "Every site we build is mobile-first. The majority of local searches happen on phones — your site will load fast, look right, and be easy to navigate on any device.",
  },
  {
    question: "What does it cost and how quickly can I launch?",
    answer:
      "Most Starter sites are live in 1\u20132 weeks from when we receive your content and photos. A free consultation will help us recommend the right package for your business.",
  },
];
...
export default function LandscapingWebsiteDesignPage() {
  return (
    <>
      <script
      ...
      >
        ...
        <span style={{ opacity: 0.4 }}>&rsaquo;</span>
        <span>Landscaping Website Design</span>
      </div>
          ...
          <div>
            ...
            <ScrollReveal>
              <p
                ...
                style={{ color: "rgba(13,27,42,0.45)" }}
              >
                Landscaping is a visual business — and your website should be
                too. A professional site for your landscaping company shows the
                quality of your work, establishes trust in your service area, and
                turns homeowners searching online into paying clients.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <div className="mt-10 flex flex-wrap gap-3.5">
                ...
                >
                  Get a Free Landscaping Website Quote
                </Link>
                <Link
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-[1fr_auto] gap-16 items-center">
            <div className="flex items-start gap-7">
              ...
              <div>
                ...
                >
                  See what a landscaping company
                  <br />
                  website looks like.
                </h2>
                <p
                  ...
                  style={{ color: "rgba(250,249,246,0.55)" }}
                >
                  We built a full demo site for GreenLine Landscaping — a
                  fictional Indianapolis landscaping company — so you can see
                  how services, project photos, and service area targeting work
                  together.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 lg:items-end flex-shrink-0">
              ...
              >
                View the Landscaping Demo &rarr;
              </Link>
              <span
            ...
            <div>
              ...
              <ScrollReveal>
                <p
                  ...
                  style={{ color: "rgba(13,27,42,0.45)" }}
                >
                  We work with landscaping companies across Indiana.{" "}
            ...
            <ScrollReveal>
              ...
              >
                ...
                <h3 className="text-[22px] font-extrabold tracking-[-0.02em] text-navy mb-2.5 leading-[1.2]">
                  Get a free quote for your landscaping website.
                </h3>
                <p
      ...
      <div className="py-20 md:py-[88px] px-6 md:px-14 bg-navy" id="quote">
        <div className="max-w-[680px] mx-auto text-center">
          ...
          <ScrollReveal>
            ...
            >
              Ready to grow your landscaping
              <br />
              business online?
            </h2>
          </ScrollReveal>
