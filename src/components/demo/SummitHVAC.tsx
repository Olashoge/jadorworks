    ...
    <div ref={mainRef}>
      ...
      <section className="py-20 md:py-28" style={{ background: C.navy2 }}>
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d196281.12937236!2d-86.3259!3d39.7684!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x886b50ffa7796a03%3A0xd68e9df640b9ea7c!2sIndianapolis%2C%20IN!5e0!3m2!1sen!2sus!4v1"
              width="100%"
              height="380"
              style={{
                border: 0,
              ...
              title="Summit Air &amp; Plumbing service area — Indianapolis, IN"
            />
          </div>
        </div>
      </section>
