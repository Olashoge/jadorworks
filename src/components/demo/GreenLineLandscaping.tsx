  ...
  return (
    <div ref={mainRef} style={{ ...outfit(400), color: C.green2, background: C.white, overflowX: "hidden" }}>
      ...
      <div style={{ background: C.green2, textAlign: "center", padding: "8px 16px", fontSize: 12, letterSpacing: ".08em", color: "rgba(255,255,255,.45)", ...outfit(500) }}>
        ...
        <a href="https://jadorworks.com" target="_blank" rel="noopener noreferrer" style={{ color: C.brownLt, textDecoration: "none", ...outfit(600) }}>
      ...
      <footer style={{ background: C.green2, padding: "64px 56px 32px" }}>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,.1)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" as const, gap: 12 }}>
          ...
          <div className="gl-footer-built" style={{ fontSize: 12, color: "rgba(255,255,255,.2)" }}>
            Built by <a href="https://jadorworks.com" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,.35)", textDecoration: "none" }}>JadorWorks Web Studio &rarr;</a>
          </div>
        </div>
      </footer>
    </div>
